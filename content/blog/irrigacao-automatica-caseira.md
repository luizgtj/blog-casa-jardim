...
author: "João Mendes"
image: "/images/irrigacao-automatica.jpg"
tags: ["irrigação", "automação", "diy", "economia", "jardinagem"]
faq:
  - question: "Precisa saber encanamento para fazer?"
    answer: "Não! O sistema usa mangueiras de PVC flexíveis e conexões que só precisam ser encaixadas (sem solda, sem ferramentas especiais)."
  - question: "O sistema funciona com água da torneira?"
    answer: "Sim, funciona com pressão normal da casa. Se quiser usar água de chuva, basta conectar na caixa d'água."
  - question: "Consome muita energia?"
    answer: "A válvula solenoide consome apenas 3W/hora. Usando 30 minutos por dia = R$ 1,50 por MÊS na conta de luz."
---

# Irrigação Automática Caseira: Sistema Profissional por R$ 187

Cansado de acordar cedo para regar plantas? Ou pior: esquecer de regar e perder suas mudas? Depois de testar 5 sistemas diferentes (e gastar R$ 800 no mais caro), desenvolvi um sistema **profissional que você monta em 2 horas** usando materiais de ferragem.

**Resultado:** Meu jardim de 50m² agora se rega sozinho, economiza 40% de água e me libera 45 minutos por dia. E o melhor: custou **R$ 187** (vs R$ 600+ dos kits prontos).
